    ...
    <div class="flex justify-center">
        <nav aria-label="Page navigation">
            <ul class="flex list-style-none">
                <!-- Previous -->
                <li v-if="prevPage" @click="getPage(props.currentPage - 1)" class="page-item cursor-pointer"><span
                ...
                <!-- Next -->
                <li v-if="nextPage" @click="getPage(props.currentPage + 1)" class="page-item cursor-pointer"><span
