      ...
      <div class="flex justify-center items-center flex-wrap h-full g-6 text-gray-800">
        ...
        <div class="w-10/12 lg:w-5/12 lg:ml-20">
          ...
          <form @submit.prevent="userStore.loginRequest(loginData)">
            ...
            <div class="text-gray-800 mt-3 mb-4 text-left">Non hai un account? <router-link :to="{ name: 'register' }"
                class="text-blue-600 hover:text-blue-400">Registrati</router-link></div>
          </form>
