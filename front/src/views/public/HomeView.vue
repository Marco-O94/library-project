            ...
            <div
                ...
                <div>
                    <div class="text-center lg:text-left">
                        <h1
                            class="text-3xl font-bold leading-tight text-gray-900 sm:text-3xl sm:leading-tight lg:leading-tight lg:text-4xl font-pj">
                            L'anima di un individuo risiede nei libri in cui legge</h1>
                        <p class="mt-2 text-lg text-gray-600 sm:mt-8 font-inter">Lorem ipsum dolor sit amet, consectetur
                            adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
                    </div>

                    <div class="flex items-center justify-center mt-10 space-x-6 lg:justify-start sm:space-x-8">
                        <div class="flex items-center">
                            <p class="text-3xl font-medium text-gray-900 sm:text-4xl font-pj">{{ bookStore.av_books }}
                            </p>
                            <p v-if="(bookStore.av_books === 1)" class="ml-3 text-sm text-gray-900 font-pj">
                                Libro<br />Disponibile</p>
                            <p v-else class="ml-3 text-sm text-gray-900 font-pj">Libri<br />in Catalogo</p>
                        </div>

                        <div class="hidden sm:block">
                            <svg class="text-gray-400" width="16" height="39" viewBox="0 0 16 39" fill="none"
                        ...
                        <div class="flex items-center">
                            <p class="text-3xl font-medium text-gray-900 sm:text-4xl font-pj">{{ bookStore.av_bookings
                            }}</p>
                            <p v-if="(bookStore.av_bookings === 1)" class="ml-3 text-sm text-gray-900 font-pj">
                                Libro<br />Prestato</p>
